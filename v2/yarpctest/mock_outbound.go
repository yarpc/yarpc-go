...
func (m *MockUnaryOutbound) Call(arg0 context.Context, arg1 *v2.Request) (*v2.Response, error) {
...
func (m *MockStreamOutbound) CallStream(arg0 context.Context, arg1 *v2.StreamRequest) (*v2.ClientStream, error) {
