...
func (v *CompareAndSwap) GetKey() (o string) { return v.Key }

// GetCurrentValue returns the value of CurrentValue if it is set or its
// zero value if it is unset.
func (v *CompareAndSwap) GetCurrentValue() (o int64) { return v.CurrentValue }

// GetNewValue returns the value of NewValue if it is set or its
// zero value if it is unset.
func (v *CompareAndSwap) GetNewValue() (o int64) { return v.NewValue }
...
// zero value if it is unset.
func (v *IntegerMismatchError) GetExpectedValue() (o int64) { return v.ExpectedValue }

// GetGotValue returns the value of GotValue if it is set or its
// zero value if it is unset.
func (v *IntegerMismatchError) GetGotValue() (o int64) { return v.GotValue }
