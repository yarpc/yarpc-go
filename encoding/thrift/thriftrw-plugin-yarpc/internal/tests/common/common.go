...
// Encode serializes a BaseService_Healthy_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a BaseService_Healthy_Args struct could not be encoded.
func (v *BaseService_Healthy_Args) Encode(sw stream.Writer) error {
...
// Decode deserializes a BaseService_Healthy_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a BaseService_Healthy_Args struct could not be generated from the wire
// representation.
func (v *BaseService_Healthy_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a BaseService_Healthy_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a BaseService_Healthy_Result struct could not be encoded.
func (v *BaseService_Healthy_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a BaseService_Healthy_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a BaseService_Healthy_Result struct could not be generated from the wire
// representation.
func (v *BaseService_Healthy_Result) Decode(sr stream.Reader) error {
...
// Encode serializes a ExtendEmpty_Hello_Args struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a ExtendEmpty_Hello_Args struct could not be encoded.
func (v *ExtendEmpty_Hello_Args) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a ExtendEmpty_Hello_Args struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a ExtendEmpty_Hello_Args struct could not be generated from the wire
// representation.
func (v *ExtendEmpty_Hello_Args) Decode(sr stream.Reader) error {
...
// Encode serializes a ExtendEmpty_Hello_Result struct directly into bytes, without going
// through an intermediary type.
//
// An error is returned if a ExtendEmpty_Hello_Result struct could not be encoded.
func (v *ExtendEmpty_Hello_Result) Encode(sw stream.Writer) error {
	if err := sw.WriteStructBegin(); err != nil {
		return err
	}
...
// Decode deserializes a ExtendEmpty_Hello_Result struct directly from its Thrift-level
// representation, without going through an intemediary type.
//
// An error is returned if a ExtendEmpty_Hello_Result struct could not be generated from the wire
// representation.
func (v *ExtendEmpty_Hello_Result) Decode(sr stream.Reader) error {
