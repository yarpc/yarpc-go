/**
 * This file was copied from gauntlet.thrift and modified to
 * work with Apache Thrift and thrift-gen. Changes made:
 *
 * - Comment out all namespaces
 * - Comment out "map<set" type in CrazyNesting to fix error -
 *     "Cannot produce a valid type for a Go map key: map[int32]bool"
 */
