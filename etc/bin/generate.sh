...
protoc_with_imports_v2() {
  protoc \
    -I . \
    "--${1}_out=${2}Mgoogle/protobuf/descriptor.proto=google.golang.org/protobuf/types/descriptorpb,Mgoogle/protobuf/duration.proto=google.golang.org/protobuf/types/known/durationpb,Mgoogle/protobuf/any.proto=google.golang.org/protobuf/types/known/anypb:." \
  "${@:3}"
}
...
protoc_yarpc_go_v2() {
  protoc_with_imports "yarpc-go-v2" "" $@
}
