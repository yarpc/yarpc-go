...
# v2 mocks
mockgen -destination=v2/yarpctest/mocks.go -package=yarpctest go.uber.org/yarpc/v2 Chooser,Dialer,Identifier,InboundCodec,List,Peer,Router,RouterMiddleware,Stream,StreamCloser,StreamEncodingHandler,StreamInboundTransportMiddleware,StreamTransportOutbound,StreamOutboundTransportMiddleware,StreamTransportHandler,Subscriber,UnaryEncodingHandler,UnaryInboundEncodingMiddleware,UnaryInboundTransportMiddleware,UnaryTransportOutbound,UnaryOutboundTransportMiddleware,UnaryTransportHandler
...
thriftrw --no-recurse --plugin=yarpc2 --out=v2/internal/internalgauntlettest/thrift v2/internal/internalgauntlettest/thrift/echo.thrift
